...
public class SpringGcpPubsubApplication {

	  private static final Log LOGGER = LogFactory.getLog(SpringGcpPubsubApplication.class);

	  public static void main(String[] args) throws IOException {
	    SpringApplication.run(SpringGcpPubsubApplication.class, args);
	  }
